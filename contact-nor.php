		...
		<div class="content cf">
			...
			<div class="primary-content"> 
				<h1>Kontakt</h1>
					...
					<p>Kontakt oss på din måte!</p>
					<p><strong>Email: </strong><a href="mailto:enquiries@daretobedigital.com"> enquiries@daretobedigital.com</a></p>
					<p>Hvis du er et team som ønsker å delta på Dare 2013, forsikre deg om at du inkluderer følgende informasjon i mailen for å hjelpe oss registrere teamets merkelapper til senere søk: gruppenavn, spill navn, gruppeleders brukernavn og gruppeleders e-post.</p>
					...
					<p><strong>Møte direkte: </strong>Hvis du er I nærheten, hvorfor ikke stikke innom og treffe andre medlemmer på <a href="http://nith.no">NITH</a>, eller Charles Butler i vårt kontor på Norges Informasjonstekniske Høgskole, Schweigaardsgate 14, N – 0185 Oslo, Norge.</p>
